...
angular.module('app').controller('ReportController', ['$scope', '$rootScope', '$routeParams', 'ReportService', function($scope, $rootScope, $routeParams, ReportService) {
	var currentSortColumn, column;
	$scope.report = ReportService.getReport($routeParams.reportId);
